...
{
    Mat img;
    // Mat img1 = imread( "/home/gao/IMG_1.png", CV_LOAD_IMAGE_GRAYSCALE ); // !debug
    Mat img1 = imread( "/home/gao/IMG_1.png",  0); // !debug
    ...
    normalize( img, img2, 0, 255, 32 ); // !debug
...
test2( )
{
    ...
    cv::Mat img2;
    // normalize( img, img2, 0, 255, CV_MINMAX ); // ! debug
    normalize( img, img2, 0, 255, 32 ); // ! debug
    Mat imageIntegralNorm;
    convertScaleAbs( img2, imageIntegralNorm );
