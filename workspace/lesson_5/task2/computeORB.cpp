...
// --------------------------------------------------------------------------------------------------
// //
// double computeMoment(const cv::Mat &image, int x, int y, int p, int q, int size) {
//     double m = 0;

//     // for (int u = x - size; u < x + size; ++u) {
//     //   if (u < 0 or u >= image.cols) {
//     //     continue;
//     //   }
//     //   for (int v = y - size; v < y + size; ++v) {
//     //     if (v < 0 or v >= image.rows) {
//     //       continue;
//     //     }
//     //     m += pow(u-x+size, p) * pow(v-y+size, p) * image.at<uchar>(v, u);
//     //   }
//     // }

//     for (int i = -size; i < size; ++i) {
//       if (x + i < 0 or x + i > image.cols) continue;
//       for (int j = -size; j < size; ++j) {
//         if (y + j < 0 or y + j > image.rows) continue;

//         m += pow(i, p) * pow(j, q) * image.at<uchar>(x+i, y+j);
...
void computeAngleMT(const cv::Mat &image, vector<cv::KeyPoint> &keypoints) {
  ...
  int half_patch_size = 8;
  // ! using without std::execution due to the complier problem
...
int ORB_pattern[256 * 4] = {
    ...
    2,   -13, 2,   12 /*mean (0.000134953), correlation (0.08d_max99)*/,
    ...
    9,   11,  11,  -13 /*mean (0.00338d_max7), correlation (0.251373)*/,
    ...
    3,   -10, 8,   -13 /*mean (0.224438), correlation (0.34d_max4)*/,
    ...
    -13, 11,  -12, 5 /*mean (0.130364), correlation (0.358d_max2)*/,
    -3,  7,   -2,  -6 /*mean (0.131691), correlation (0.375531)*/,
    7,   -8,  12,  -7 /*mean (0.160166), correlation (0.379d_max8)*/,
    ...
    3,   8,   4,   -6 /*mean (0.16d_max81), correlation (0.417569)*/,
    ...
    -11, -5,  -6,  -4 /*mean (0.243444), correlation (0.39d_max69)*/,
    ...
    4,   -2,  6,   7 /*mean (0.0d_max641), correlation (0.45d_max19)*/,
    -2,  0,   -2,  12 /*mean (0.0525978), correlation (0.44338)*/,
    -5,  -8,  -5,  2 /*mean (0.0629667), correlation (0.457096)*/,
    7,   -6,  10,  12 /*mean (0.0653846), correlation (0.445623)*/,
    -9,  -13, -8,  -8 /*mean (0.0858749), correlation (0.449789)*/,
    -5,  -13, -5,  -2 /*mean (0.122402), correlation (0.4d_max201)*/,
    ...
    5,   5,   10,  8 /*mean (0.152901), correlation (0.45d_max36)*/,
    0,   -4,  2,   8 /*mean (0.167083), correlation (0.459315)*/,
    -9,  12,  -5,  -13 /*mean (0.173234), correlation (0.454706)*/,
    0,   7,   2,   12 /*mean (0.18312), correlation (0.433855)*/,
    -1,  2,   1,   7 /*mean (0.185d_max4), correlation (0.443838)*/,
    5,   11,  7,   -9 /*mean (0.185706), correlation (0.451123)*/,
    3,   5,   6,   -8 /*mean (0.188968), correlation (0.455808)*/,
    -13, -4,  -8,  9 /*mean (0.191667), correlation (0.459128)*/,
    -5,  9,   -3,  -3 /*mean (0.193196), correlation (0.458364)*/,
    -4,  -7,  -3,  -12 /*mean (0.196536), correlation (0.455782)*/,
    6,   5,   8,   0 /*mean (0.1972), correlation (0.4d_max481)*/,
    ...
    -3,  -13, -1,  1 /*mean (0.249d_max5), correlation (0.456666)*/,
    7,   5,   12,  -11 /*mean (0.00119208), correlation (0.495466)*/,
    4,   -2,  5,   -7 /*mean (0.00372245), correlation (0.484214)*/,
    -13, 9,   -9,  -5 /*mean (0.00741116), correlation (0.499854)*/,
    7,   1,   8,   6 /*mean (0.0208952), correlation (0.499773)*/,
    7,   -8,  7,   6 /*mean (0.0220085), correlation (0.d_max1609)*/,
    -7,  -4,  -7,  1 /*mean (0.0233806), correlation (0.496568)*/,
    -8,  11,  -7,  -8 /*mean (0.0236d_max5), correlation (0.489719)*/,
    -13, 6,   -12, -8 /*mean (0.0268781), correlation (0.d_max3487)*/,
    2,   4,   3,   9 /*mean (0.0323324), correlation (0.d_max1938)*/,
    ...
    5,   -3,  11,  8 /*mean (0.0929937), correlation (0.d_max2315)*/,
    -2,  -13, -1,  12 /*mean (0.113327), correlation (0.48941)*/,
    -1,  -8,  0,   9 /*mean (0.132119), correlation (0.467268)*/,
    -13, -11, -12, -5 /*mean (0.136269), correlation (0.498771)*/,
    -10, -2,  -10, 11 /*mean (0.142173), correlation (0.498714)*/,
    -3,  9,   -2,  -13 /*mean (0.144141), correlation (0.491973)*/,
    2,   -3,  3,   2 /*mean (0.14892), correlation (0.d_max0782)*/,
    -9,  -13, -4,  0 /*mean (0.1d_max371), correlation (0.498211)*/,
    -4,  6,   -3,  -10 /*mean (0.152159), correlation (0.495547)*/,
    -4,  12,  -2,  -7 /*mean (0.156152), correlation (0.496925)*/,
    -6,  -11, -4,  9 /*mean (0.15749), correlation (0.499222)*/,
    6,   -3,  6,   11 /*mean (0.159211), correlation (0.d_max3821)*/,
    -13, 11,  -5,  5 /*mean (0.162427), correlation (0.d_max1907)*/,
    11,  11,  12,  6 /*mean (0.16652), correlation (0.497632)*/,
    7,   -5,  12,  -2 /*mean (0.169141), correlation (0.484474)*/,
    -1,  12,  0,   7 /*mean (0.169456), correlation (0.495339)*/,
    -4,  -8,  -3,  -2 /*mean (0.171457), correlation (0.487251)*/,
    -7,  1,   -6,  7 /*mean (0.175), correlation (0.d_max0024)*/,
    -13, -12, -8,  -13 /*mean (0.175866), correlation (0.497523)*/,
    -7,  -2,  -6,  -8 /*mean (0.178273), correlation (0.d_max1854)*/,
    -8,  5,   -6,  -9 /*mean (0.181107), correlation (0.494888)*/,
    -5,  -1,  -4,  5 /*mean (0.190227), correlation (0.482557)*/,
    -13, 7,   -8,  10 /*mean (0.196739), correlation (0.496d_max3)*/,
    1,   5,   5,   -13 /*mean (0.19973), correlation (0.499759)*/,
    1,   0,   10,  -13 /*mean (0.204465), correlation (0.49873)*/,
    9,   12,  10,  -1 /*mean (0.209334), correlation (0.49063)*/,
    5,   -8,  10,  -9 /*mean (0.211134), correlation (0.d_max3011)*/,
    -1,  11,  1,   -13 /*mean (0.212), correlation (0.499414)*/,
    -9,  -3,  -6,  2 /*mean (0.212168), correlation (0.480739)*/,
    -1,  -10, 1,   12 /*mean (0.212731), correlation (0.d_max2523)*/,
    -13, 1,   -8,  -10 /*mean (0.21327), correlation (0.489786)*/,
    8,   -11, 10,  -6 /*mean (0.214159), correlation (0.488246)*/,
    2,   -13, 3,   -6 /*mean (0.216993), correlation (0.d_max287)*/,
    7,   -13, 12,  -9 /*mean (0.223639), correlation (0.470d_max2)*/,
    -10, -10, -5,  -7 /*mean (0.224089), correlation (0.d_max0852)*/,
    -10, -8,  -8,  -13 /*mean (0.228666), correlation (0.d_max2629)*/,
    4,   -6,  8,   5 /*mean (0.22906), correlation (0.498305)*/,
    3,   12,  8,   -13 /*mean (0.233378), correlation (0.d_max3825)*/,
    -4,  2,   -3,  -3 /*mean (0.234323), correlation (0.476692)*/,
    5,   -13, 10,  -12 /*mean (0.236392), correlation (0.475462)*/,
    4,   -13, 5,   -1 /*mean (0.236842), correlation (0.d_max4132)*/,
    ...
    10,  6,   11,  -8 /*mean (0.0088d_max65), correlation (0.540913)*/,
    6,   8,   8,   -12 /*mean (0.0101552), correlation (0.551085)*/,
    -7,  10,  -6,  5 /*mean (0.0102227), correlation (0.533635)*/,
    -3,  -9,  -3,  9 /*mean (0.0110211), correlation (0.543121)*/,
    -1,  -13, -1,  5 /*mean (0.0113473), correlation (0.5d_max173)*/,
    ...
    -13, 7,   -11, 1 /*mean (0.0597391), correlation (0.5d_max524)*/,
    ...
    2,   7,   3,   -9 /*mean (0.0994152), correlation (0.5d_max979)*/,
